package com.riosoft.application.data.generator;

import com.vaadin.flow.spring.annotation.SpringComponent;

import com.riosoft.application.data.service.SamplePersonRepository;
import com.riosoft.application.data.entity.SamplePerson;
import com.riosoft.application.data.service.UserRepository;
import com.riosoft.application.data.entity.User;
import java.util.Collections;
import org.springframework.security.crypto.password.PasswordEncoder;
import com.riosoft.application.data.Role;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2021, 8, 7, 0, 0, 0));
